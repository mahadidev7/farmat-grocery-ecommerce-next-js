      ...
      <div className="container">
        ...
        <div className="my-10 flex flex-wrap gap-10 justify-between">
          ...
          <div className="max-w-sm">
            ...
            <div className="mt-10 space-y-2">
              ...
              <span className="flex">
                ...
                <p className="ml-4">mahadidev7@gmail.com</p>
              </span>
            </div>
          </div>
          {/* Links */}
          ...
          <div className="lg:max-w-sm">
            ...
            <p>Register now to get updates on promotions and coupons. Do not worry! We not spam</p>
        ...
        <div className="py-8 flex flex-wrap space-y-3 justify-center md:justify-between items-center border-t ">
          <p className="text-sm">© {new Date().getFullYear()} <a href="https://github.com/mahadidev7" className="underline" target="_blank" rel="noreferrer">Mahadi Hasan</a>. No Rights Reserved 🙂. Build for fun.</p>
